...
# Actually get the different library directories
...
if (BLAS_LIBRARIES_DIR OR BLAS_LIBRARIES)
  ...
  string(REGEX REPLACE "[,; :]+" " " LD_LIBRARY_PATH "${LD_LIBRARY_PATH}")
  ...
  message("LD_LIBRARY_PATH = ${LD_LIBRARY_PATH}")
    ...
    if(NOT BLAS_LIBRARIES)
      ...
      ""
      "sgemm;dgemm;blas"
      "ENV BLAS_LIB_DIR ${CMAKE_INSTALL_PREFIX}/lib ${LD_LIBRARY_PATH}"
      )
    endif()
    ...
    if(NOT BLAS_LIBRARIES)
      ...
      ""
      "complib.sgimath"
      "${CGAL_TAUCS_LIBRARIES_DIR} ENV BLAS_LIB_DIR;${LD_LIBRARY_PATH}"
      )
    endif()
